...
//                    webView.loadUrl(MainActivity.ipAddress+MainActivity.contextPath+"/Equip/equipList.do?equip_cd="+selectEquipKey);
                }
            });
        }
    }
...
//                            Fragment fm = getFragmentManager().findFragmentByTag("dfdf");
    ...
    public void writeCheck() {
        webView.loadUrl("javascript:fn_equipCheckInsert('" + MainActivity.loginSabun +"','" + selectWorkerKey +"')");
    }
