...
//                            Fragment fm = getFragmentManager().findFragmentByTag("dfdf");
    ...
    public void goCheck() {
        ...
        bundle.putString("url", MainActivity.ipAddress+MainActivity.contextPath+"/Gear/gearCheck.do?gear_cd="+selectGearKey+"&loginSabun="+MainActivity.loginSabun);
    ...
    public void goCheckHistory() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("selectGearKey",selectGearKey);
        bundle.putString("url", MainActivity.ipAddress+MainActivity.contextPath+"/Gear/gear_check_history.do?gear_cd="+selectGearKey);
