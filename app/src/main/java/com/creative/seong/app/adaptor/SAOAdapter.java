...
public class SAOAdapter extends BaseAdapter{
	...
	public SAOAdapter(Context con , ArrayList<HashMap<String,Object>> array){
	...
	public View getView(final int position, final View convertview, ViewGroup parent) {
		...
		if(v == null){
			...
			v = inflater.inflate(R.layout.safe_list_item, parent,false);
