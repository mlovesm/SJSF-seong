...
//    private String url = "http://192.168.0.20:9191/RestAPI/rest/API/sampleList";
    private String l_url = MainActivity.ipAddress+ MainActivity.contextPath+"/rest/Safe/safe_lCategoryList";
    private String m_url = MainActivity.ipAddress+ MainActivity.contextPath+"/rest/Safe/safe_mCategoryList/large_cd=";
    ...
    public void getHistory() {
        ...
        intent.putExtra("title", "안전관리이력팝업");
