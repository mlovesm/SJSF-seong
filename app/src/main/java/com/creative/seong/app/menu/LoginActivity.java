...
//        startActivity(new Intent(this, SplashActivity.class));	//스플래시 로딩 화면 띄우기
...
//        });
        ...
        if(callback.equals("loginCheck")){  //로그인
            ...
            url=MainActivity.ipAddress+MainActivity.contextPath+"/rest/Login/loginCheckApp/sid="+_sabun_no.getText()+"/password="+_user_pw.getText();

        }else if(callback.equals("getUserInfo")){   //조회
            InputMethodManager imm= (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
            imm.hideSoftInputFromWindow(_sabun_no.getWindowToken(), 0);
            url=MainActivity.ipAddress+MainActivity.contextPath+"/rest/Login/sid_check_ajax/sid="+_sabun_no.getText();
        }
